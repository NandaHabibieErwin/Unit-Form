            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div v-if="loading" class="flex items-center justify-center min-h-[200px]">
                    <div class="flex items-center space-x-2">
                        <div class="w-5 h-5 border-4 border-yellow-500 border-t-transparent rounded-full animate-spin">
                        </div>
                ...
                <div v-if="isModalOpen"
                    ...
                    <div
                        ...
                        <div class="space-y-6">
                            ...
                            <!-- Unit Number Input -->
                            <div class="relative group">
                                <input v-model="no_unit" type="text" placeholder="Search by unit number"
                                    class="w-full px-4 py-3 bg-yellow-100 text-gray-800 rounded-lg shadow-sm focus:ring-4 focus:ring-yellow-300 focus:outline-none transition group-hover:shadow-md" />
                                <i
                            ...
                            <!-- Date Input -->
                            <div class="relative group">
                                <input v-model="tanggal_data" type="date"
                                    class="w-full px-4 py-3 bg-yellow-100 text-gray-800 rounded-lg shadow-sm focus:ring-4 focus:ring-yellow-300 focus:outline-none transition group-hover:shadow-md" />
                                <i
                                    class="fas fa-calendar-alt absolute right-4 top-1/2 transform -translate-y-1/2 text-yellow-700 group-hover:text-yellow-900"></i>
                            </div>

                            <!-- Eligibility Dropdown -->
                            <div class="relative group">
                                <select v-model="kelayakan"
                                    class="w-full px-4 py-3 bg-yellow-100 text-gray-800 rounded-lg shadow-sm focus:ring-4 focus:ring-yellow-300 focus:outline-none transition group-hover:shadow-md">
                                ...
                                <i
                                    class="fas fa-check-circle absolute right-4 top-1/2 transform -translate-y-1/2 text-yellow-700 group-hover:text-yellow-900"></i>
                            </div>
                        </div>
