/**
  ...
  *
  * @checksum - f34201172634837240d4d434d9369fa35aaab83abca5198fb122e7b32a6e6823
  * @variables - radius=rounded-lg,accentColor=yellow,colorTemperature=neutral,spacing=2,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
