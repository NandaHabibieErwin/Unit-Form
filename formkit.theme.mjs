/**
  ...
  *
  * @checksum - b3451faeadf01f6c9b4a06427c3c0b06f27906676aefe92a68e064c0cb172386
  * @variables - radius=rounded-lg,accentColor=yellow,colorTemperature=zinc,spacing=2,scale=base,inputShadow=shadow-md,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
